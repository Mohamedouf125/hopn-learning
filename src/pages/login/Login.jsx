...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      {/* ///////// */}
      <div
        className={`flex flex-col justify-center items-center overflow-hidden rounded-[40px] w-[45%] min-h-[750px] max-w-[597px]`}
      >
        <div
          ref={overlayRref}
        ...
        >
            ...
            {welcomeSlides.map((slide, index) => {
              return (
                <div
                  ...
                  className={
                    slider === index
                      ? `flex flex-col justify-center items-center gap-2.5 bg-white/90 py-5 rounded-[20px] overflow-hidden w-[75%] mx-auto py-7.5 px-[30px] showWelcomeBox`
                      : `flex flex-col justify-center items-center gap-2.5 bg-white/90 py-5 rounded-[20px] overflow-hidden w-[75%] mx-auto py-7.5 px-[30px] hideWelcomeBox`
                  }
                >
                  <h1
                    className={`font-[Tajawal] text-[19.45px] font-bold leading-[27px] tracking-[-0.98px] text-center text-[#212529]`}
                  >
                    {slide.header}
                  </h1>
                  <p
                    className={`font-[Tajawal] text-[14px] font-normal leading-[26px] text-center text-[#777777]`}
                  >
                    {slide.description}
                  </p>
                </div>
          ...
          <div
            className={`flex justify-center items-center gap-1.75 mt-5 w-full gap-2`}
          >
